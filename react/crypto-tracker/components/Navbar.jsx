    ...
    return (
        <div className="text-white flex flex-col md:flex-row justify-between items-center w-full bg-gray-800 px-4 py-3 gap-3 md:gap-0 shadow-xl fixed">
            ...
            <div className="flex justify-around gap-3 sm:gap-5 items-center w-full md:w-auto">
                    ...
                    <div className="relative">
                        <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                            <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true" className="w-4 h-4 text-gray-500 dark:text-gray-400">
                                <path d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"
                                    strokeWidth={2} strokeLinejoin="round" strokeLinecap="round" stroke="currentColor" />
                            </svg>
                        </div>
                        <input
                            required
                            placeholder="Search"
                            className="block w-full p-3 ps-10 text-base md:text-lg text-gray-900 border border-gray-300 rounded-lg bg-gray-50 
                                       focus:ring-blue-500 focus:border-blue-500 outline-none 
                                       dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                            type="search"
                        />
                        <button className="absolute end-2.5 bottom-1/2 translate-y-1/2 p-2 md:p-3 text-sm font-medium text-white 
                ...
                {/* Currency Selector */}
                <div className="relative inline-flex items-center px-3 py-1 border border-gray-600 bg-gray-700 rounded-xl w-20 shadow-2xl h-11">
                    <select
                    ...
                    >
                        <option value="USD" className="bg-stone-800">USD</option>
                        <option value="INR" className="bg-stone-800">INR</option>
                    </select>
